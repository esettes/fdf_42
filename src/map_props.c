...
/*   Updated: 2022/06/14 21:20:08 by iostancu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// {
// 	fdf->mtrx.zoom = 1;
// 	fdf->mtrx.px_size = (t_vec2 *)malloc(sizeof(t_vec2));
// 	fdf->mtrx.start_draw = (t_vec2 *)malloc(sizeof(t_vec2));
// 	fdf->mtrx.end_draw = (t_vec2 *)malloc(sizeof(t_vec2));
// }
